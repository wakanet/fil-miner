...
./etcd --name $netname --initial-advertise-peer-urls http://$netip:2180 \
  --data-dir=/data/zfs/etcd/${netname}.etcd \
  --listen-peer-urls http://$netip:2180 \
  --listen-client-urls http://$netip:2179,http://127.0.0.1:2179 \
  --advertise-client-urls http://$netip:2179 \
