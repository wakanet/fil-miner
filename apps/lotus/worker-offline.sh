...
RUST_LOG=info RUST_BACKTRACE=1 NETIP=$netip ./lotus-worker run --id-file="$worker_id_file" --listen-addr="$netip:1287" --max-tasks=0 --parallel-pledge=0 --parallel-precommit1=0 --parallel-precommit2=0 --parallel-commit=0 --commit2-srv=true --offline-srv=true --offline-grant-sn=f3c7d77b-0ebb-ffdf-884f-573d7a34d9f1 &
pid=$!
