...
../../bin/etcd --name $netname --initial-advertise-peer-urls http://$netip:2080 \
  --data-dir=/data/zfs/etcd/${netname}.etcd \
  --listen-peer-urls http://$netip:2080 \
  --listen-client-urls http://$netip:2079,http://127.0.0.1:2079 \
  --advertise-client-urls http://$netip:2079 \
