...
export BUILD_GIT_COMMIT="github.com/gwaycc/goapp/version.GitCommit" # 'sup build' should should fill this var
...
export PUB_ROOT_RES="apps doc etc bin script install.sh README.md"
